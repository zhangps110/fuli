...
// @match           *://yt1s.com/facebook-downloader
//---------------------------------------------------
// @match      	  *music.163.com*
// @match           *://y.qq.com*
// @match           *://www.kugou.com*
...
// @match           *://npcitem.jd.hk/*
// @match           *://www.laisoyixia.com/download/detail**
// @match           *://www.xiaozhukuaipan.com/download/**
//----------------------------------------------------
// @match           *://www.baidu.com/*
// @match           *://www.so.com/s*
	...
	function superVideoHelper(originalInterfaceList){
		...
		this.addHtmlElements = function(){  //添加HTML
			...
			var htmlMould = `<div id='vip_movie_box`+this.elementId+`'>
							...
							`;
			$("#vip_movie_box"+this.elementId).remove();
	...
	function superVideoHelperMobile(originalInterfaceList){
			...
			return new Promise((resolve, reject)=>{
				const elementInterval = setInterval(()=>{
					...
					var cssMould = `
							...
							#select_interface_modal_warp_`+this.elementId+`>div >span{
							...
							#select_interface_modal_warp_`+this.elementId+`>div >span:nth-child(4n){
								margin-right:0px;
							}
							#select_interface_modal_warp_`+this.elementId+`>div >span.item{
								
							}
							#select_interface_modal_warp_`+this.elementId+`>div >span.item-active:after{
								position: absolute;
								content: " ";
								height: 2px;
								width: 50%;
		...
		this.runEvent = function(){	 //事件运行
			...
			$("body").on("touchstart", "#select_interface_modal_warp_"+this.elementId+" span.item", function(){
				...
				$("#select_interface_modal_warp_"+this.elementId+" span.item").removeClass("item-active");
